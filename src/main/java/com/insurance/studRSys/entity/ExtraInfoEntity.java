...
import com.insurance.studRSys.modal.ExtraInfo;
...
public class ExtraInfoEntity {
    ...
    private ExtraInfoEntity(Builder builder) {
        setId(builder.id);
        setGeneralInfoId(builder.generalInfoId);
    ...
    public static Builder newBuilder(ExtraInfo copy) {
    ...
    /**
     * {@code ExtraInfoEntity} builder static inner class.
     */
    public static final class Builder {
        ...
        /**
         * Sets the {@code generalInfoId} and returns a reference to this Builder so that the methods can be chained together.
         *
         * @param val the {@code generalInfoId} to set
         * @return a reference to this Builder
         */
        public Builder setGeneralInfoId(Long val) {
            generalInfoId = val;
            return this;
        }
        ...
        /**
         * Returns a {@code ExtraInfoEntity} built from the parameters previously set.
         *
         * @return a {@code ExtraInfoEntity} built with parameters of this {@code ExtraInfoEntity.Builder}
         */
        public ExtraInfoEntity build() {
            return new ExtraInfoEntity(this);
        }
    }
}
